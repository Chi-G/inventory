                ...
                >
                    {kpis.map((kpi, i) => (
                        <motion.div 
                            ...
                            className={`bg-white p-6 rounded-[2rem] border ${kpi.borderColor} shadow-sm hover:shadow-md transition-all group`}
                        >
                            ...
                            <h3 className="text-sm font-bold text-slate-500 uppercase tracking-widest">{kpi.name}</h3>
                            <p className="text-3xl font-black text-slate-900 mt-1">{kpi.value}</p>
                            <p className="text-xs text-slate-400 mt-2 font-medium">{kpi.description}</p>
                        </motion.div>
                    ))}
                </motion.div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 flex flex-col gap-6">
                        <div className="flex justify-between items-center px-2">
                            ...
                            <Link href={route('inventory.logs')} className="text-sm font-bold text-indigo-600 hover:text-indigo-700 flex items-center gap-1">
                                View full audit
